  		...
  		<div class="box box-primary">
            ...
            <div class="box-body no-padding">
              <table class="table table-striped">
                ...
                <tbody>
                  <?php $counter1=-1;  if( isset($users) && ( is_array($users) || $users instanceof Traversable ) && sizeof($users) ) foreach( $users as $key1 => $value1 ){ $counter1++; ?><!--no rain tpl assim que usamos um laço de repetição -->
                  <tr>
                    <td><?php echo htmlspecialchars( $value1["iduser"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td><!-- mostrar os valores-->
                    ...
                    <td><!--if dentro do rain tpl vai mostrar sim ou não ao invés do 0 e 1 -->
